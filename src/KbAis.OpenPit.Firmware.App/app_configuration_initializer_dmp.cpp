...
// TODO: Move heavy work from ctor to method
app_configuration_initializer_dmp::app_configuration_initializer_dmp(
    app_configuration_manager& manager
) {
    manager.register_by_name(QStringLiteral("base"), default_configuration_base);
    manager.register_by_name(QStringLiteral("ethernet"), default_configuration_ethernet);
    manager.register_by_name(QStringLiteral("networking"), default_configuration_networking);
    manager.register_by_name(QStringLiteral("scale"), default_configuration_scale);
}
