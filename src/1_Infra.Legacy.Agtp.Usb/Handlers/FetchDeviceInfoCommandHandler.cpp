#include "FetchDeviceInfoCommandHandler.h"

FetchDeviceInfoCommandHandler::FetchDeviceInfoCommandHandler() {
...
AgtpCommandResult
FetchDeviceInfoCommandHandler::handle(const AgtpCommand& command) {
