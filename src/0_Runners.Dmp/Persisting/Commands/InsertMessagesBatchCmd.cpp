#include "InsertMessagesBatchCmd.h"
...
void
InsertMessagesBatchCmd::handle(const MessagesBatch& messagesBatch) {
...
QPair<bool, quint32>
InsertMessagesBatchCmd::insertMessagesBatch(
...
bool
InsertMessagesBatchCmd::insertMessages(
    const QSqlDatabase& connection,
