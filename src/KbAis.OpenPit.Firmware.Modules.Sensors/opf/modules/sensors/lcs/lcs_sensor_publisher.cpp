...
rxcpp::observable<lcs_sensor_message> lcs_sensor_publisher::get_observable(
    [[maybe_unused]] const rxcpp::observe_on_one_worker& c
) const {
    return rxcpp::observable<>::empty<lcs_sensor_message>();
}

void lcs_sensor_publisher::config_serialport_connection() {
...
void lcs_sensor_publisher::handle_ready_read() {
