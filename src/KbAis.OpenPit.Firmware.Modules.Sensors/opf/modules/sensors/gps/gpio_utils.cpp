...
QDir GPIO_DIRECTORY { "/sys/class/gpio" };
...
void gpio_utils::export_pin(int pin) {
...
void gpio_utils::setup_dir(int pin, PinDirection dir) {
...
void gpio_utils::setup_val(int pin, bool val) {
