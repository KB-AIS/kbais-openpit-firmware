...
#include "RxQt.h"
#include "modules/sensors/serials/crd/crd_formatter_tkcardreader_modbus.h"
...
public:
    virtual rxcpp::observable<crd_sensor_message> get_observable(const rxcpp::observe_on_one_worker& coord) const = 0;
